...
int main(int argc, char* argv[])
{
    char* szNombre = new char[50];
    char(*szPalabras)[TAMTOKEN] = new char[NUMPALABRAS][TAMTOKEN];
    int* iEstadisticas = new int[NUMPALABRAS];
    int i;
    int iNumElementos;
    int iNumSugeridas;
    char* szPalabraLeida = new char[TAMTOKEN];
    char(*szPalabrasSugeridas)[TAMTOKEN] = new char[3300][TAMTOKEN];
    char(*szListaFinal)[TAMTOKEN] = new char[3300][TAMTOKEN];
    int* iPeso = new int[3300];
    int iNumLista;
    ...
    printf("Numero de elementos en la lista: %i\n", iNumElementos);
    strcpy_s(szPalabraLeida, TAMTOKEN, "");
    while (strcmp(szPalabraLeida, "fin"))
    {
        printf("\nDigite una palabra o 'fin' para terminar: ");
        scanf_s("%s", szPalabraLeida, TAMTOKEN);
        _strlwr_s(szPalabraLeida, TAMTOKEN);
        ClonaPalabras(szPalabraLeida, szPalabrasSugeridas, iNumSugeridas);
    ...
    delete[] szNombre;
    delete[] szPalabras;
    delete[] iEstadisticas;
    delete[] szPalabraLeida;
    delete[] szPalabrasSugeridas;
    delete[] szListaFinal;
    delete[] iPeso;
